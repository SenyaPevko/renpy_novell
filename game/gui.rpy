...
define gui.text_font = "gui/fonts/BalsamiqSans-Regular.ttf"
...
define gui.main_menu_background = Movie(play="video/main_menu.webm", loop = True, size = (1920,1080))
...
## порядку.
define gui.namebox_borders = Borders(20, 7, 20, 7)
