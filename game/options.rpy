...
define gui.about = _p("""
Визуальная новелла «Upgrade of juniors», это подвид текстового квеста, в нем вам откроется возможность прочувствовать себя в роли среднестатистического работника IT сферы, которому предстоит принять и возглавить группу молодых специалистов. В этой истории вы сможете прочувствовать наше представление о быте разработчиков игр на Unity. В процессе создания новеллы, мы фокусировалась на цели показать наше видение, а так же заинтересовать игрока этой стезей IT. Мы думаем, что «Upgrade of juniors» поможет ознакомиться и проникнуться этой интересной и увлекательной работой. Это первый совместный проект команды и в ее создании нам пришлось пройти через много трудностей. Надеемся вы оцените его по достоинству. Желаем вам успехов в ваших начинаниях. 
""")
...
define config.save_directory = "capybara-1667823186"
